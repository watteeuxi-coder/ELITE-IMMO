...
export default function LeadsPage() {
    ...
    return (
        <div className="flex flex-col min-h-0 lg:h-[calc(100vh-160px)] space-y-4 md:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-2 md:gap-3 w-full md:w-auto">
                    <div className="relative w-full sm:w-64">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 bg-white border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#7084FF]/20 text-sm w-full shadow-sm"
                        />
                    </div>
                    <div className="flex gap-2 w-full sm:w-auto">
                        <button
                            ...
                            className={cn(
                                "p-2 border rounded-xl transition-all flex-[0.2] sm:flex-none flex justify-center items-center shadow-sm",
                        ...
                        >
                            ...
                            <span className="whitespace-nowrap">{t('nav_new_lead')}</span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 flex-1 min-h-0">
                {/* Leads List */}
                <div className="w-full lg:w-80 glass rounded-3xl overflow-hidden flex flex-col h-[200px] sm:h-[250px] lg:h-full shrink-0">
